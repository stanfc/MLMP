...
PANELS = [
    {
        ...
        "curves": [
            ...
            ("ACDCDataset/deyo_mlmp_gradanchor_continual", "#7f7f7f", "GradAnchor (method2)"),
            ("ACDCDataset/deyo_mlmp_gradlagadapt_continual", "#8c564b", "GradLagAdapt (method1)"),
            ("ACDCDataset/deyo_mlmp_gradlagadapt_continual_hybrid", "#17becf", "Method1-Hybrid"),
            ("ACDCDataset/deyo_mlmp_gradlagadapt_continual_hybrid_lowrst", "#bcbd22", "Hybrid-lowrst"),
            ("ACDCDataset/deyo_mlmp_gradratio_continual", "#e377c2", "GradRatio (proposed)"),
        ],
    ...
    },
    {
        ...
        "curves": [
            ...
            ("CityscapesDataset/deyo_mlmp_gradanchor_continual_5corr_sub100", "#7f7f7f", "GradAnchor (method2)"),
            ("CityscapesDataset/deyo_mlmp_gradlagadapt_continual_5corr_sub100", "#8c564b", "GradLagAdapt (method1)"),
            ("CityscapesDataset/deyo_mlmp_gradlagadapt_continual_hybrid_5corr_sub100", "#17becf", "Method1-Hybrid"),
            ("CityscapesDataset/deyo_mlmp_gradlagadapt_continual_hybrid_lowrst_5corr_sub100", "#bcbd22", "Hybrid-lowrst"),
            ("CityscapesDataset/deyo_mlmp_gradratio_continual_5corr_sub100", "#e377c2", "GradRatio (proposed)"),
        ],
    ...
    },
    {
        ...
        "curves": [
            ...
            ("PascalVOC20Dataset/deyo_mlmp_gradanchor_continual_5corr_sub100", "#7f7f7f", "GradAnchor (method2)"),
            ("PascalVOC20Dataset/deyo_mlmp_gradlagadapt_continual_5corr_sub100", "#8c564b", "GradLagAdapt (method1)"),
            ("PascalVOC20Dataset/deyo_mlmp_gradlagadapt_continual_hybrid_5corr_sub100", "#17becf", "Method1-Hybrid"),
            ("PascalVOC20Dataset/deyo_mlmp_gradlagadapt_continual_hybrid_lowrst_5corr_sub100", "#bcbd22", "Hybrid-lowrst"),
            ("PascalVOC20Dataset/deyo_mlmp_gradratio_continual_5corr_sub100", "#e377c2", "GradRatio (proposed)"),
        ],
