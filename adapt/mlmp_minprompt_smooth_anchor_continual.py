"""
MLMP-MinPrompt-SmoothAnchor-Continual: MLMP min-prompt loss + smooth-anchor gate.
"""
...
class MLMPMinPromptSmoothAnchorContinual:
    ...
    def __init__(self, ovss_type, ovss_backbone, lr, classes,
        ...
        print(f"+++ MLMP-MinPrompt-SmoothAnchor: T={len(self.prompt_templates)}, "
    ...
    def _update_lag(self):
        ...
        if log_change:
            print(f"[MLMP-MP-SA] B{self.total_batches}: H={h:.3f}  "
