...
class DeYOMLMPHMGateContinual:
    ...
    def _update_gate(self):
        ...
        if slope <= self.slope_deadzone or self.windows_since_min < 1:
            ...
            # DEEP cap only in the collapse regime (H_margin dropped); otherwise
            # SHALLOW cap so the slow climb (VOC20) is never suppressed.
            if collapse_regime:
        ...
        print(f"[DeYO-MLMP-HMGate] B{self.total_batches}: grad={g:.3f} "
