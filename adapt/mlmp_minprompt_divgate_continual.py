"""
MLMP-MinPrompt-DivGate-Continual: MLMP min-prompt loss + 3-tier discrete DivGate.
"""
...
class MLMPMinPromptDivGateContinual:
    ...
    def __init__(self, ovss_type, ovss_backbone, lr, classes,
        ...
        print(f"+++ MLMP-MinPrompt-DivGate: T={len(self.prompt_templates)}, "
    ...
    def _update_mode(self):
        ...
        if new_mode != self.current_mode:
            print(f"[MLMP-MinPrompt-DivGate] B{self.total_batches}: H={h:.3f}  "
