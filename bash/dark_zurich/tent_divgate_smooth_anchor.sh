#!/bin/bash
# TENT-DivGate-SMOOTH-ANCHOR on Dark Zurich (CTTA, N rounds).
...
# bash/dark_zurich/tent_divgate_continual.sh (H_THRESHOLD=1.6, H_WARNING=1.4,
# CAUTIOUS_RST=0.01). Only the restoration TARGET differs vs the baseline.
