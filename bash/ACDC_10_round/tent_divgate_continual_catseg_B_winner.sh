#!/bin/bash
# CatSeg DivGate sweep — B_winner on GPU 1.
# H_THR=1.6, H_WARN=1.4, CAU=0.01, BRAKE=0.05.
...
TAG="B_winner_h${H_THRESHOLD}_${H_WARNING}_cau${CAUTIOUS_RST}_brake${BRAKE_RST}"
