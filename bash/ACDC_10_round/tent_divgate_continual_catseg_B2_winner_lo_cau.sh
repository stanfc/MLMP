#!/bin/bash
# CatSeg DivGate sweep — B2_winner_lo_cau on GPU 1.
# H_THR=1.6, H_WARN=1.4, CAU=0.005, BRAKE=0.05.
...
TAG="B2_winner_lo_cau_h${H_THRESHOLD}_${H_WARNING}_cau${CAUTIOUS_RST}_brake${BRAKE_RST}"
