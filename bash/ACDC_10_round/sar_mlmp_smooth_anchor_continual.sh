#!/bin/bash
# SAR-MLMP-SmoothAnchor on ACDC (CTTA, 150 rounds).
# SAR (SAM + reliable filter) + full MLMP (multi-prompt/layer + UAML eval)
# + smooth-anchor restoration (lag(H) continuous in marginal-diversity H).
# See docs/sar_mlmp_smooth_anchor_continual_spec.md.
