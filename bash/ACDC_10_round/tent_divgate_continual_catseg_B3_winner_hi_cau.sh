#!/bin/bash
# CatSeg DivGate sweep — B3_winner_hi_cau on GPU 1.
# H_THR=1.6, H_WARN=1.4, CAU=0.02, BRAKE=0.05.
...
TAG="B3_winner_hi_cau_h${H_THRESHOLD}_${H_WARNING}_cau${CAUTIOUS_RST}_brake${BRAKE_RST}"
