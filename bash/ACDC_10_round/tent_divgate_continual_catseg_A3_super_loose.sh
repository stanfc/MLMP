#!/bin/bash
# CatSeg DivGate sweep — A3_super_loose on GPU 0.
# H_THR=1.8, H_WARN=1.5, CAU=0.001, BRAKE=0.02.
...
TAG="A3_super_loose_h${H_THRESHOLD}_${H_WARNING}_cau${CAUTIOUS_RST}_brake${BRAKE_RST}"
