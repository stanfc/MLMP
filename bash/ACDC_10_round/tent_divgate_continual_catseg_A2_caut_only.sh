#!/bin/bash
# CatSeg DivGate sweep — A2_caut_only on GPU 0.
# H_THR=1.8, H_WARN=1.5, CAU=0.01, BRAKE=0.02.
...
TAG="A2_caut_only_h${H_THRESHOLD}_${H_WARNING}_cau${CAUTIOUS_RST}_brake${BRAKE_RST}"
