#!/bin/bash
# CatSeg DivGate sweep — C2_loose_thr_high on GPU 2.
# H_THR=1.7, H_WARN=1.5, CAU=0.005, BRAKE=0.02.
...
TAG="C2_loose_thr_high_h${H_THRESHOLD}_${H_WARNING}_cau${CAUTIOUS_RST}_brake${BRAKE_RST}"
