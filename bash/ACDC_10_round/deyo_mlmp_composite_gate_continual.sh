#!/bin/bash
# deyo_mlmp_composite_gate_continual on ACDCDataset.
...
# conf_ceil on the GATE-INTERNAL conf scale (adapt ensemble), NOT evaluate-conf.
# Prev run: 0.85 (evaluate-conf peak) never triggered -> collapsed. Gate-internal
# conf at peak R34 ~0.70, at collapse-onset R45 ~0.74 -> fire at 0.74.
CONF_CEIL=0.74
BASE_RST=0.005
GRAD_MULT_MAX=4.0
MONITOR_INTERVAL=50
