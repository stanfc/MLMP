#!/bin/bash
# CatSeg DivGate sweep — D3_brake_active on GPU 3.
# H_THR=1.8, H_WARN=1.7, CAU=0.005, BRAKE=0.05.
...
TAG="D3_brake_active_h${H_THRESHOLD}_${H_WARNING}_cau${CAUTIOUS_RST}_brake${BRAKE_RST}"
