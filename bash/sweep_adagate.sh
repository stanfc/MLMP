...
arm_cfg() {
  case "$1" in
    ctrl)           echo "abs   0.002 gain 1.5" ;;
    Amad0)          echo "mad   0.0   gain 1.5" ;;
    Amad05)         echo "mad   0.5   gain 1.5" ;;
    Amad10)         echo "mad   1.0   gain 1.5" ;;
    Atstat10)       echo "tstat 1.0   gain 1.5" ;;
    Becdf)          echo "abs   0.002 ecdf 1.5" ;;
    ABmad0_ecdf)    echo "mad   0.0   ecdf 1.5" ;;
    ABmad05_ecdf)   echo "mad   0.5   ecdf 1.5" ;;
    ABmad10_ecdf)   echo "mad   1.0   ecdf 1.5" ;;
    ABmad15_ecdf)   echo "mad   1.5   ecdf 1.5" ;;
    ABmad20_ecdf)   echo "mad   2.0   ecdf 1.5" ;;
