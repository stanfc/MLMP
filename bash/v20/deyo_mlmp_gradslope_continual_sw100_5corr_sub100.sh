#!/bin/bash
# deyo_mlmp_gradslope_continual on PascalVOC20Dataset (5corr sub100).
...
# capped the climb (peak only 75.0). 100 windows ~= 5000 batch (10 rounds) smooths
...
SAVE_DIR="save/${DATASET}/${METHOD}_sw100_5corr_sub100/"
