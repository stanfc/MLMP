#!/bin/bash
# no-gate (deyo_mlmp_continual) on PascalVOC20Dataset — FULL val set (1449 imgs),
# ALL 15 ImageNet-C corruptions, 50 rounds. Missing no-gate baseline for the
# VOC20 full+15corr panel.
