#!/bin/bash
# deyo_mlmp_gradlagadapt_continual on PascalVOC20Dataset (5corr sub100).
...
METHOD="deyo_mlmp_gradlagadapt_continual"
OVSS_TYPE="naclip"
...
SAVE_DIR="save/${DATASET}/${METHOD}_hybrid_lowrst_5corr_sub100/"
