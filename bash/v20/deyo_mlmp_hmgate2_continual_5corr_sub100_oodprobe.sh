#!/bin/bash
# deyo_mlmp_hmgate2_continual on PascalVOC20Dataset (5corr sub100).
...
SAVE_DIR="save/${DATASET}/${METHOD}_5corr_sub100_oodprobe/"
...
CUDA_VISIBLE_DEVICES=$GPU_ID python main_continual.py \
                        ...
                        \
                        --ood_corruptions gaussian_noise shot_noise impulse_noise defocus_blur glass_blur \
                        --save_dir $SAVE_DIR \
                        --class_extensions
