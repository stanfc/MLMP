#!/bin/bash
# MLMP-Continual on Cityscapes-C (5 corruptions, sub=100, 150 rounds).
# Full MLMP loss WITH ILE (alpha_cls=1.0). No gate, no restoration.
# Companion to mlmp_continual_no_ile_5corr_sub100 (alpha_cls=0.0)
# and mlmp_smooth_anchor_continual_5corr_sub100 (with gate).
