...
OUTPUT_CSV = os.path.join(REPO_DIR, "results", "results_v20_mlmp_variants.csv")

# MLMP variants to compare
METHODS = ["mlmp_batch1_steps_10_trails_1", "mlmp_2", "mlmp_continual_64"]
