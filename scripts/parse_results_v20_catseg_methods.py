...
CATSEG_DIR = os.path.join(SAVE_DIR, "PascalVOC20Dataset_catseg")
OUTPUT_CSV = os.path.join(REPO_DIR, "results", "results_v20_catseg_methods.csv")

# Methods to compare
METHODS = ["No_Adaptation", "mlmp", "mlmp_continual", "dpcore"]
...
for method in METHODS:
    method_dir = os.path.join(CATSEG_DIR, method)
