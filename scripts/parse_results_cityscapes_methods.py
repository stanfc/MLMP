...
CITYSCAPES_DIR = os.path.join(SAVE_DIR, "CityscapesDataset")
OUTPUT_CSV = os.path.join(REPO_DIR, "results", "results_cityscapes_methods.csv")

# Methods to compare
METHODS = ["No_Adaptation", "mlmp", "tent", "cotta", "mlmp_continual", "tent_continual", "dpcore"]
...
for method in METHODS:
    method_dir = os.path.join(CITYSCAPES_DIR, method)
