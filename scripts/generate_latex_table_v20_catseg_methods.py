...
INPUT_CSV = os.path.join(RESULTS_DIR, "results_v20_catseg_methods.csv")
OUTPUT_TEX = os.path.join(RESULTS_DIR, "results_v20_catseg_methods_table.tex")
...
METHOD_ORDER = ["No_Adaptation", "mlmp", "mlmp_continual", "dpcore"]
...
def build_metric_table(data, metric_type="mIoU"):
    ...
    lines.append(f"\\caption{{V20 CAT-Seg Method Comparison - {metric_display[metric_type]}.}}")
    lines.append(f"\\label{{tab:v20_catseg_{metric_type.lower()}}}")
