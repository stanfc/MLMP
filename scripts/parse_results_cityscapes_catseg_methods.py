...
CITYSCAPES_CATSEG_DIR = os.path.join(SAVE_DIR, "CityscapesDataset_catseg")
OUTPUT_CSV = os.path.join(REPO_DIR, "results", "results_cityscapes_catseg_methods.csv")

# Methods to compare
METHODS = ["No_Adaptation", "mlmp", "cotta", "mlmp_continual"]
...
for method in METHODS:
    method_dir = os.path.join(CITYSCAPES_CATSEG_DIR, method)
