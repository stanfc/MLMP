...
Output: figures/gdgpa_emaeval_3datasets.png
"""
import os
import numpy as np
...
labels = [
    ...
    "GDG-PA (ours)",
    "GDG-PA + EMA-eval (ours)",
]
fig.legend(handles, labels, fontsize=15, loc="lower center",
           bbox_to_anchor=(0.5, -0.04), ncol=4, framealpha=0.95)
fig.tight_layout()
os.makedirs("figures", exist_ok=True)
fig.savefig("figures/gdgpa_emaeval_3datasets.png", dpi=135, bbox_inches="tight")
print("saved -> figures/gdgpa_emaeval_3datasets.png")
