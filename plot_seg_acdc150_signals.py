...
Outputs: figures/seg_acdc150_gradnorm_vs_miou.png
         figures/seg_acdc150_hmargin_vs_miou.png
"""
import os
import numpy as np
...
RUN = "save/ACDCDataset/deyo_mlmp_hmgate2_continual_150R"
OUT = "figures"
...
C_MIOU = "#d62728"
SPECS = [
    ("grad_norm", "gradient norm", "#8c564b", (4.8, 5.7),
     "seg_acdc150_gradnorm_vs_miou",
     r"ViT-seg / ACDC 150R: mIoU vs gradient norm"),
    ("h_margin", r"$H_{\mathrm{margin}}$", "#1f77b4", (2.15, 2.5),
     "seg_acdc150_hmargin_vs_miou",
     r"ViT-seg / ACDC 150R: mIoU vs $H_{\mathrm{margin}}$"),
]
